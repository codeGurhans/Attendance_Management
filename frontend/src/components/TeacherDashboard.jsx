  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="view-toggle" style={{ marginBottom: '20px' }}>
        <button 
          className={`btn ${viewMode === 'mark' ? 'btn-active' : ''}`} 
          onClick={() => setViewMode('mark')}
          style={{ marginRight: '10px', backgroundColor: viewMode === 'mark' ? '#2980b9' : '#95a5a6' }}
        >
          Mark Attendance
        </button>
        <button 
          className={`btn ${viewMode === 'view' ? 'btn-active' : ''}`} 
          onClick={() => setViewMode('view')}
          style={{ backgroundColor: viewMode === 'view' ? '#2980b9' : '#95a5a6' }}
        >
          View Attendance
        </button>
      </div>
